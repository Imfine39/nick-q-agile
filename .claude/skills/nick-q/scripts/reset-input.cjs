 ...
 *
 * Usage:
 *   node .claude/skills/nick-q/scripts/reset-input.cjs vision    # Reset vision input only
 *   node .claude/skills/nick-q/scripts/reset-input.cjs add       # Reset add input only
 *   node .claude/skills/nick-q/scripts/reset-input.cjs fix       # Reset fix input only
 *   node .claude/skills/nick-q/scripts/reset-input.cjs all       # Reset all input files
 *   node .claude/skills/nick-q/scripts/reset-input.cjs --list    # List available input types
 */
...
function showHelp() {
  console.log('Usage: node .claude/skills/nick-q/scripts/reset-input.cjs <type>');
  console.log('');
  console.log('Types:');
  ...
  console.log('  node .claude/skills/nick-q/scripts/reset-input.cjs vision');
  console.log('  node .claude/skills/nick-q/scripts/reset-input.cjs all');
}
