 ...
 *
 * Examples:
 *   node .claude/skills/nick-q/scripts/scaffold-spec.cjs --kind vision --id S-VISION-001 --title "Project Vision"
 *
 *   node .claude/skills/nick-q/scripts/scaffold-spec.cjs --kind domain --id S-DOMAIN-001 --title "System Domain"
 *     --vision S-VISION-001 --masters M-CLIENT,M-ORDER --apis API-ORDER-LIST
 *
 *   node .claude/skills/nick-q/scripts/scaffold-spec.cjs --kind screen --id S-SCREEN-001 --title "System Screens"
 ...
 *     --issue 50
 *
 *   node .claude/skills/nick-q/scripts/scaffold-spec.cjs --kind test-scenario --id TS-SALES-001 --title "Sales Recording Tests"
...
function getTemplatePath(kind) {
  ...
  return path.join(process.cwd(), '.claude', 'skills', 'nick-q', 'templates', templateFile);
}
