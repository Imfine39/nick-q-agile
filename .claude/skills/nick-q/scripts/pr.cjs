 ...
 *
 * Usage:
 *   node .claude/skills/nick-q/scripts/pr.cjs --title "feat: add sales" --body "Fixes #123\nImplements S-SALES-001"
 *   node .claude/skills/nick-q/scripts/pr.cjs --title "feat: add sales" --body-file pr-body.md
 *
 * Flags:
...
Usage:
  node .claude/skills/nick-q/scripts/pr.cjs --title <title> --body <body> [options]
...
Examples:
  node .claude/skills/nick-q/scripts/pr.cjs --title "feat: add sales" --body "Fixes #123\\nImplements S-SALES-001"
  node .claude/skills/nick-q/scripts/pr.cjs --title "feat: add sales" --body-file pr-body.md --test "npm test"
`);
}
...
function main() {
  ...
  if (lint) {
    ...
    run('node .claude/skills/nick-q/scripts/spec-lint.cjs');
  }
  if (test) {
