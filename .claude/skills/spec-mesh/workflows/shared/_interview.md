...
> **完了するまで継続的にインタビューを行う。質問数に制限はない。**
>
> 40問以上になることもある。ユーザーの負担より、完璧な仕様を優先する。
...
|-------------|-------------------|-----------|
| vision.md | Spec 生成後、Multi-Review 前 | **必須** |
...
|-----------|---------|--------------|
| Vision | Business, Strategy | 長期目標、競合優位性、成功指標、スケーラビリティ |
...
> **コンポーネント参照:** [shared/_interview.md](shared/_interview.md)
